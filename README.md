[![Build Status](https://dev.azure.com/SudiptaChatterjee/ContosoAir/_apis/build/status%2Fcuscat.ContosoAir?branchName=master)](https://dev.azure.com/SudiptaChatterjee/ContosoAir/_build/latest?definitionId=2&branchName=master)
